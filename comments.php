...
<?php if ( have_comments() ) : ?>
	...
	<nav id="comment-nav">
		<ul class="clearfix">
	  		<li><?php esc_url(previous_comments_link( __("Older comments","bonestheme") ) ) ?></li>
	  		<li><?php esc_url(next_comments_link( __("Newer comments","bonestheme") ) ) ?></li>
	 	</ul>
	</nav>
...
<section id="respond" class="respond-form">
	...
	<div id="cancel-comment-reply">
		<p class="small"><?php esc_url(cancel_comment_reply_link( __("Cancel","bonestheme") ) ); ?></p>
	</div>

	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
  	<div class="help">
  		<p><?php _e("You must be","bonestheme"); ?> <a href="<?php echo esc_url(wp_login_url( get_permalink() )); ?>"><?php _e("logged in","bonestheme"); ?></a> <?php _e("to post a comment","bonestheme"); ?>.</p>
  	</div>
	<?php else : ?>

	<form action="<?php echo esc_url(get_option('siteurl')); ?>/wp-comments-post.php" method="post" class="form-vertical" id="commentform">

	<?php if ( is_user_logged_in() ) : ?>

	<p class="comments-logged-in-as"><?php _e("Logged in as","bonestheme"); ?> <a href="<?php echo esc_url(get_option('siteurl')); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo esc_url(wp_logout_url(get_permalink())); ?>" title="<?php _e("Log out of this account","bonestheme"); ?>"><?php _e("Log out","bonestheme"); ?> &raquo;</a></p>

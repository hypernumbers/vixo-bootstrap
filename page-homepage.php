					...
					<div id="myCarousel" class="carousel">
					    ...
					    <div class="carousel-inner">
						    ...
						    <div class="<?php if($post_num == 1){ echo 'active'; } ?> item">
						    	<a href="<?php esc_url(the_permalink()) ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'wpbs-featured-carousel' ); ?></a>
					                ...
					                <p>
					                	<?php
					                		...
					                		if($the_excerpt != ""){
					                			...
					                			echo $the_excerpt . '... ';
					                	?>
					                	<a href="<?php esc_url(the_permalink()) ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" class="btn btn-primary">Read more &rsaquo;</a>
					                	<?php } ?>
					                </p>

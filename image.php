				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header> 
							...
							<p class="meta"><?php _e("Posted", "bonestheme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_date(); ?></time> <?php _e("by", "bonestheme"); ?> <?php esc_url(the_author_posts_link()); ?>.</p>
						...
						<section class="post_content clearfix" itemprop="articleBody">
							...
							<ul id="gallery-nav" class="clearfix">
								<li class="next pull-left"><?php esc_url(next_image_link()) ?></li>
								<li class="previous pull-right"><?php esc_url(previous_image_link()) ?></li>
							</ul>
